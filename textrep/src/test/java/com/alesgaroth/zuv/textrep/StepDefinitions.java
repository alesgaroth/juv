...
public class StepDefinitions {
  ...
  public void an_algorithm(String algo) {
     algorithm = AlgoFactory.get(algo, Index.createRoot(algo));
  }
  ...
  public void i_get_the_named(String algo) {
      Algorithm other = AlgoFactory.get(algo, Index.createRoot(algo));
  ...
  public void i_dont_get_the_named(String algo) {
      assertFalse(algorithm.equivalentTo(AlgoFactory.get(algo, Index.createRoot(algo))));
  }
